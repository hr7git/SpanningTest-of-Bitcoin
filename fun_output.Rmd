...
1) HK test :     $α = 0N$     and    $\gamma = iN - βiK = 0$

2) step test 1 : $α = 0N$

3) step test 2 : $𝛾 = iN - βiK = 0$  <br>
   condition on  $α = 0N$   
...
<br>Q - bench asset --> SPY TLT GLD only ( stock bond + GLD:becuase of psudeo money character)  
<br>Q - period --> all / before & after covid19  
<br>Q - Heteroskedecity option before/after apply - change the probability  
<br>Q - test portfolio (1.BTC / 2.ETH / 3.BTC+ETH)  
<br>Q - SSR / SST --> wald test option ( equation verify)  

<br>Q2 - test:BTC+ETH / bench: as add assets / data: after covid19
    -  after add IEF : significantly different

<br>1. Efficient Frontier Line 
...
####
#
# source("C:/Users/hanap/Dropbox/ak2424/KD/7. R/r_test_0216/function/tailoredFrontierPlot2.R")
# source("C:/Users/hanap/Dropbox/ak2424/KD/7. R/r_test_0216/function/frontierPlot2.R")
# source('C:/Users/hanap/Dropbox/ak2424/KD/7. R/r_test_0216/function/eff_line_plot.R')
# eff_line_plot(rets2)
# eff_line_plot(rets2["/2019"])
# eff_line_plot(rets2["2020/"])
